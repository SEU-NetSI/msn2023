...
<div data-role="content" style="text-align:left;padding-top: 0em;background-color:#e4e5e6">
  <div  class="ui-block-a" style="width:70%;height:100%;background-color:#ffffff;padding-left: 50px;padding-right:80px;padding-top: 15px;">
    ...
    <a style="text-decoration: none;" target="_blank" href="https://ieeecps.org/#!/auth/login?ak=1&pid=7IqNxxPyeDMmOynUJHNyXL"><button style="width: auto;background: rgb(192,0,0);"><b style="font-size: 20px;color:white">Camera Ready and Copyright Submission Link</b></button></a>
    <br>

    <p>Camera ready versions of accepted papers must be submitted by using the recommended format and presented by one of the authors at the conference for inclusion in the conference proceedings and submission to IEEE Xplore. In addition, the IEEE copyright form has to be submitted and at least one author of the paper must <a href="registration.php">register</a> to the conference as an AUTHOR at the author registration rate <b>25 October 2022 </b> even if the author is a student.</p>
    ...
    <ul data-role="listview" data-inset="true" data-theme="a" data-content-theme="a" class="datetbl">
        <?php add_dateitem("<b>Tuesday, 25 October 2022 (11:59pm PDT)</b>", "Camera ready"); ?>
        <?php add_dateitem("<b>Tuesday, 25 October 2022 (11:59pm PDT)</b>", "Copyright"); ?>
        <?php add_dateitem("<b>Tuesday, 25 October 2022 (11:59pm PDT)</b>", "Registration"); ?>
    </ul>
