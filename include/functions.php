...
function add_listitem_email($name, $organization, $link) {
  ...
  <li data-icon="false">
    <div class="ui-grid-b">
      ...
      <div class="ui-block-c">
        <?php if ($link) { ?><a href="mailto:<?php echo $link ?>" target="_blank" rel="external" class="nodecor"><?php } ?>
          <p><?php echo $link ?></p>
        <?php if ($link) { ?></a><?php } ?>
      </div>
    </div>
...
?>
    <li data-icon="false" class="prog-item <?php echo $progitemclass; ?>">
      ...
      <div class="ui-li-aside-item">
        <?php if ($has_link) { ?>
        <div class="button-paper">      
          <a target = "_blank" href="<?php echo $link ?>" class="ui-link">Paper</a>
        </div>
        <?php } ?>
        <?php if ($has_slides) { ?>
        <div class="button-paper">      
          <a target = "_blank" href="<?php echo $slides ?>" rel="external" target="_blank" class="ui-link">Slides</a>
        </div>
        <?php } ?>
        <?php if ($has_video) { ?>
        <div class="button-paper">
...
?>
    <li data-icon="false" class="prog-item <?php echo $progitemclass; ?> prog-keynote">
      ...
      <?php if ($has_abstract || $has_bio) { ?>
        <hr class="keynote-divider"/>
        <?php if ($has_abstract) { ?>
          <p><?php if ($photo) { ?><img class="keynote-photo" src="<?php echo $photo ?>"/><?php } ?><b>Abstract: </b><?php echo $abstract ?></p><p>&nbsp;</p><p><b>Bio: </b><?php echo $bio ?></p><p>&nbsp;</p>
        <?php } ?>
