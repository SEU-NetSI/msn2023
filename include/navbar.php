...
<div data-role="navbar" style="width:100%;max-width: 1200px;">
  <ul class="mybar">
    <li class="ui-block-a" style="width:15%;"><a href="index.php" class="mybar-item <?php if($mypage == "index.php"){echo 'btn-selected-ui';}?>" >Home</a></li>
    <li class="ui-block-b" style="width:17%;">
      <div class="dropdown">
