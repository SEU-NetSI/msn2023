...
<div data-role="content" class="topbar" style="background-color: white">
  ...
  <div class="ui-block-b" style="width:55%;height:100%; font-weight: bold;font-size:1.5em;margin-top: 13px">
    The 17th International Conference on Mobility, Sensing and Networking (MSN 2021)<br><span style="font-weight: normal;font-size:0.8em">December 13-15, 2021, Exeter, UK</span>
  </div>
...
<!--             <a href="tech.php">Technical Program&nbsp;&nbsp;</a>
    ...
    <li>
      <div class="dropdown">
        <a class = "mybar-item dropbtn <?php if($mypage == "plat.php" || $mypage == "acco.php"){echo 'btn-selected-ui';}?>"href="plat.php" >Conference Virtual Platform</a>
        <div class="dropdown-content">
