...
<div data-role="content" style="text-align:left;padding-top: 0em;background-color:#e4e5e6">
    <div  class="ui-block-a" style="width:70%;height:100%;background-color:#ffffff;padding-left: 35px;padding-right:35px;padding-top: 15px;">
        ...
        <ul>
            <li><b>Every accepted paper</b> (in the conference/ workshop) must have one author register at the Author Registration rate, even if the author is a student, <b>by 25 October 2022</b>, and presented by the author at the conference. </li>
            ...
            <li>Papers for which none of the authors is registered by the deadline will not be included in the conference program and proceedings.</li>
        </ul>
        ...
        <p><b>Author in-person registrations</b> include: access to the conference venue, 3 daily coffee breaks, 1 lunch per day, <span style="background-color:rgb(255, 234, 0);">1 ticket for the welcome reception</span>, 1 ticket for the banquet, presentation and publication of one paper (the registrant must be a co-author of the associated paper). </p>
        ...
        <p><b>Conference in-person registrations</b> include: access to the conference venue, 3 daily coffee breaks, 1 lunch per day,  <span style="background-color:rgb(255, 234, 0);">1 ticket for the welcome reception</span>, 1 ticket for the banquet. </p>
        ...
        <ul>
            ...
            <li>To be published in the MSN 2022 Conference Proceedings and to be eligible for publication in IEEE Xplore, at least one author of an accepted paper is required to register for the conference at the Author Registration Rate even if the author is a student, and present the paper at the conference.</li>
            <li>The accepted paper must be presented by an author of that paper at the conference.</li>
            <li>Papers without registered author(s) by 25 October 2022 will not be included in the conference program and proceedings.</li>
        </ul>
