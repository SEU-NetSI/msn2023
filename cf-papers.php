...
<!-- 		<h2>Best Paper Award and Journal Special Issues</h2>
		...
		<ul data-role="listview" data-inset="true" data-theme="a" data-content-theme="a" class="datetbl">
		    ...
		    <?php add_dateitem("<span style=\"color: red;font-weight: bold\">Sep 15, 2022</span>", "<span style=\"color: red;font-weight: bold\">Author Notification</span>"); ?>
		    <?php add_dateitem("Sep 30, 2022", "Author Notification"); ?>
