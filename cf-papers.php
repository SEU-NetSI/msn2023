...
<!-- 		<h2>Best Paper Award and Journal Special Issues</h2>
		...
		<ul data-role="listview" data-inset="true" data-theme="a" data-content-theme="a" class="datetbl">
		    ...
		    <?php add_dateitem("<span style=\"color: red;font-weight: bold\">July 15, 2022</span>", "<span style=\"color: red;font-weight: bold\">Paper Submission Due(extended)</span>"); ?>
		    <?php add_dateitem("Sep 15, 2022", "Author Notification"); ?>
